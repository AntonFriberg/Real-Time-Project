...
public class ServerReceive extends Thread {
    /**
     * Receives changes to the current camera mode. Each camera has one receive thread and
     * communicates with the client via byte array and expects CMM for motion and CMI for idle.
     */
